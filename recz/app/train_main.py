...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default=r"/home/amhs/toolid/first", type=str, help="dataset path")
    ...
    parser.add_argument(
        "-j", "--workers", default=20, type=int, metavar="N", help="number of data loading workers (default: 4)"
    )
    ...
    parser.add_argument("--output-dir", default="./Result", type=str, help="path to save logs")
    parser.add_argument("--ckpt-path", default="/home/amhs/wingsky/pths", type=str, help="path to save pth file")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if best_acc < acc_m_valid.avg or epoch == args.epochs - 1:
            ...
            checkpoint = {
                ...
                "args": args,
                "best_acc": best_acc}
            pkl_name = "wingsky_best.pth".format(epoch) if epoch == args.epochs - 1 else "checkpoint_last.pth"
            #path_checkpoint = os.path.join(log_dir, pkl_name)
            path_checkpoint = os.path.join(ckpt_path, pkl_name)
